...
fun Rectangle46(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_predioagregar_rectangle_46),
...
fun Rectangle47(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_predioagregar_rectangle_47),
        modifier = modifier.requiredWidth(46.0.dp).requiredHeight(46.0.dp)
    )
}
...
fun Rectangle48(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_predioagregar_rectangle_48),
        modifier = modifier.requiredWidth(46.0.dp).requiredHeight(46.0.dp)
    )
}
