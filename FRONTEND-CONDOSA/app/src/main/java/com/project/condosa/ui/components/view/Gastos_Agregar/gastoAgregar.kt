...
@Composable
fun GastoAgregar(modifier: Modifier = Modifier) {
    TopLevel(modifier = modifier) {
        Group6 {
            ...
            Boton1(
                ...
                Rectangle46(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
                Boton3(
                    modifier = Modifier.boxAlign(
                        alignment = Alignment.Center,
                        offset = DpOffset(
...
@Composable
private fun GastoAgregarPreview() {
    MaterialTheme {
        RelayContainer {
            GastoAgregar(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Rectangle52(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_52),
        modifier = modifier.requiredWidth(318.0.dp).requiredHeight(371.0.dp)
    )
}

@Composable
fun AAdirGasto(modifier: Modifier = Modifier) {
    RelayText(
...
fun Rectangle45(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_45),
...
fun Line8(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.  ),
...
fun Vector2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_vector),
...
fun Rectangle44(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_44),
...
fun Rectangle46(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_46),
        modifier = modifier.fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Rectangle47(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_47),
        modifier = modifier.requiredWidth(46.0.dp).requiredHeight(46.0.dp)
    )
}
...
fun Line9(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_line_9),
        modifier = modifier.requiredWidth(190.62498474121094.dp).requiredHeight(0.0.dp)
    )
}
...
fun Vector5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_vector2),
...
fun Vector3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_vector1),
...
fun Rectangle48(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_rectangle_48),
        modifier = modifier.requiredWidth(46.0.dp).requiredHeight(46.0.dp)
    )
}
...
fun Line10(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_line_10),
        modifier = modifier.requiredWidth(190.62498474121094.dp).requiredHeight(0.0.dp)
    )
}
...
fun Vector7(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.gasto_agregar_vector3),
        modifier = modifier.requiredWidth(13.5.dp).requiredHeight(6.75.dp)
    )
}
...
fun Cost(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.gasto_agregar_cost),
